...
class CodexSwitch < Formula
  ...
  homepage "https://github.com/soundadam/homebrew-dist/releases/tag/codex-switch-v0.1.0"
  url "https://github.com/soundadam/homebrew-dist/releases/download/codex-switch-v0.1.0/codex-switch-0.1.0.tar.gz"
