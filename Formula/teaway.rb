...
class Teaway < Formula
  ...
  homepage "https://github.com/soundadam/homebrew-dist/releases/tag/teaway-v0.2.2"
  url "https://github.com/soundadam/homebrew-dist/releases/download/teaway-v0.2.2/teaway-0.2.2.tar.gz"
